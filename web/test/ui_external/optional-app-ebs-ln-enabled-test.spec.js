// Test for the Resource overview page with EBS-LN enabled
...
const applicationTotalRequirementsTests = [
  {index: 1, name: 'CPU Requests', expectedHeading: 'CPU:', expectedValue: 'Requests: 23 vCPU (+ 0.10 vCPU/worker)'},
  {index: 2, name: 'Memory Requests', expectedHeading: 'Memory:', expectedValue: 'Requests: 135 GiB (+ 0.10 GiB/worker)'}
]
...
const clusterResourceOverviewTests = [
  {index: 1, name: 'Total Pods', expectedValue: 'Total Pods: 30'},
